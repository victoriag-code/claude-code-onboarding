    ...
    let html = `
        ...
        <table style="border-collapse: collapse; width: 100%; max-width: 600px;">
            ...
            <tr>
                ...
                <td style="padding: 10px; border: 1px solid #ddd;">${data.org_uuid || 'Not provided'}</td>
            </tr>
            <tr style="background: #f5f5f5;">
        ...
        <div style="background: #fff3cd; border: 2px solid #ffc107; padding: 15px; margin-top: 20px; border-radius: 5px;">
            ...
            <p style="color: #856404;">This customer selected the per-user license option and requires sales team follow-up within 24 hours to arrange licensing transition.</p>
        </div>
        ` : ''}
...
Organization UUID: ${data.org_uuid || 'Not provided'}
Current AI Tools: ${data.current_tools || 'None specified'}

${data.license_type === 'per-user' ? `
ATTENTION: Sales Follow-up Required
This customer selected the per-user license option and requires sales team follow-up within 24 hours.
` : ''}
        ...
        if (process.env.SEND_CONFIRMATION === 'true') {
            const confirmationMail = {
                ...
                html: `
                    ...
                    <ul>
                        <li>Our sales team will contact you within 24 hours to arrange your per-user licensing</li>
...
${customerData.license_type === 'per-user' ?
`What happens next:
- Our sales team will contact you within 24 hours to arrange your per-user licensing
